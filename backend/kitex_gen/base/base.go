...
type TrafficEnv struct {
	Open bool   `thrift:"Open,1" frugal:"1,default,bool" form:"Open" json:"Open" query:"Open"`
	Env  string `thrift:"Env,2" frugal:"2,default,string" form:"Env" json:"Env" query:"Env"`
}
...
type Base struct {
	LogID      string            `thrift:"LogID,1" frugal:"1,default,string" form:"LogID" json:"LogID" query:"LogID"`
	Caller     string            `thrift:"Caller,2" frugal:"2,default,string" form:"Caller" json:"Caller" query:"Caller"`
	Addr       string            `thrift:"Addr,3" frugal:"3,default,string" form:"Addr" json:"Addr" query:"Addr"`
	Client     string            `thrift:"Client,4" frugal:"4,default,string" form:"Client" json:"Client" query:"Client"`
	TrafficEnv *TrafficEnv       `thrift:"TrafficEnv,5,optional" frugal:"5,optional,TrafficEnv" form:"TrafficEnv" json:"TrafficEnv,omitempty" query:"TrafficEnv"`
	Extra      map[string]string `thrift:"Extra,6,optional" frugal:"6,optional,map<string:string>" form:"Extra" json:"Extra,omitempty" query:"Extra"`
}
