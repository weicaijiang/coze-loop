...
func (p *kObservabilityTraceServiceClient) IngestTraces(ctx context.Context, req *trace.IngestTracesRequest, callOptions ...callopt.Option) (r *trace.IngestTracesResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
