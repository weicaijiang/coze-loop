...
// Source: github.com/coze-dev/cozeloop/backend/modules/foundation/domain/user/repo (interfaces: IUserRepo)
//
...
import (
	...
	repo "github.com/coze-dev/cozeloop/backend/modules/foundation/domain/user/repo"
