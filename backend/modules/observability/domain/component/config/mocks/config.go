...
// Source: github.com/coze-dev/cozeloop/backend/modules/observability/domain/component/config (interfaces: ITraceConfig)
//
...
import (
	...
	config "github.com/coze-dev/cozeloop/backend/modules/observability/domain/component/config"
